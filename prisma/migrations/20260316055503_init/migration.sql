-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('PR_CONFLICT', 'CI_FAILURE', 'MERGE_ERROR', 'CODE_ERROR', 'PR_REVIEW_REQUESTED');

-- CreateEnum
CREATE TYPE "EventStatus" AS ENUM ('PENDING', 'RESOLVING', 'RESOLVED', 'FAILED', 'IGNORED');
